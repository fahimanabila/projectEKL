...
function Search(){
	if(document.searchform.cari.value == ""){
		alert("Isikan kata yang akan dicari!");
		document.searchform.cari.focus();
	}else{
		document.searchform.action = '/search.asp';
